...
public class WireComponentLibrary {
    ...
    private void initializeAND() {
        ...
        andGate.addPointToStructure(0,0);
        andGate.addPointToStructure(1,0);
        andGate.addPointToStructure(2,0);
        andGate.addPointToStructure(3,0);
        andGate.addPointToStructure(4,0);
        andGate.addPointToStructure(5,0);
        andGate.addPointToStructure(6,0);
        andGate.addPointToStructure(7,0);
        andGate.addPointToStructure(8,1);
        andGate.addPointToStructure(9,1);
        andGate.addPointToStructure(10,1);
        andGate.addPointToStructure(5,2);
        andGate.addPointToStructure(7,2);
        andGate.addPointToStructure(11,2);
        andGate.addPointToStructure(0,3);
        andGate.addPointToStructure(4,3);
        andGate.addPointToStructure(5,3);
        andGate.addPointToStructure(6,3);
        andGate.addPointToStructure(11,3);
        andGate.addPointToStructure(1,4);
        andGate.addPointToStructure(3,4);
        andGate.addPointToStructure(5,4);
        andGate.addPointToStructure(7,4);
        andGate.addPointToStructure(9,4);
        andGate.addPointToStructure(11,4);
        andGate.addPointToStructure(14,4);
        andGate.addPointToStructure(15,4);
        andGate.addPointToStructure(1,5);
        andGate.addPointToStructure(3,5);
        andGate.addPointToStructure(8,5);
        andGate.addPointToStructure(9,5);
        andGate.addPointToStructure(10,5);
        andGate.addPointToStructure(13,5);
        andGate.addPointToStructure(1,6);
        andGate.addPointToStructure(3,6);
        andGate.addPointToStructure(9,6);
        andGate.addPointToStructure(11,6);
        andGate.addPointToStructure(12,6);
        andGate.addPointToStructure(2,7);
    }
    ...
    private void initializeXOR() {
        ...
        xorGate.addPointToStructure(0,1);
        xorGate.addPointToStructure(3,1);
        xorGate.addPointToStructure(2,2);
        xorGate.addPointToStructure(3,2);
        xorGate.addPointToStructure(4,2);
        xorGate.addPointToStructure(5,2);
        xorGate.addPointToStructure(2,3);
        xorGate.addPointToStructure(4,3);
        xorGate.addPointToStructure(5,3);
        xorGate.addPointToStructure(6,3);
        xorGate.addPointToStructure(2,4);
        xorGate.addPointToStructure(3,4);
        xorGate.addPointToStructure(4,4);
        xorGate.addPointToStructure(5,4);
        xorGate.addPointToStructure(0,5);
        xorGate.addPointToStructure(3,5);
        xorGate.addPointToStructure(1,6);
        xorGate.addPointToStructure(2,6);
    }
